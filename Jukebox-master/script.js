...
{
  this.playing = false;
  this.songs = [new Song(new Audio('songs/bensound-actionable.mp3'),"Actionable", "Bensound"),
                new Song(new Audio('songs/bensound-anewbeginning.mp3'),"A New Beginning","Bensound"),
                new Song(new Audio('songs/bensound-dance.mp3'),"Dance","Bensound")
               ]
